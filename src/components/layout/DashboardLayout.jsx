...
const DashboardLayout = ({ children }) => {
  ...
  useEffect(() => {
    if (hasAIAssistant && !entitlementsLoading) {
      loadActiveConversation();
    }
  }, [hasAIAssistant, entitlementsLoading]);
                ...
                <div className="flex flex-col h-full bg-slate-950 text-white">
                  ...
                  <div className="flex-1 overflow-y-auto p-4 flex items-center justify-center">
                    <LockedFeatureCard
                      ...
                      description="AI Assistant is not included in your current subscription plan. Upgrade your subscription plan to unlock AI-powered patient and clinic assistance."
                    />
                  </div>
                </div>
              )}
