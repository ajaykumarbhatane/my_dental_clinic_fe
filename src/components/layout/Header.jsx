                  ...
                  <div className="w-full h-full bg-white shadow-2xl overflow-hidden flex flex-col">
                    <div className="flex items-center justify-between px-4 py-4 border-b border-gray-100">
                      <div>
                        ...
                        <h3 className="text-lg font-bold text-slate-900">Upcoming reminders</h3>
                      </div>
                      <button
                        type="button"
                            ...
                            <article key={reminder.id} className="rounded-2xl bg-white shadow-sm border border-slate-200 p-4">
                              <div className="min-w-0">
                                {reminder.kind === 'plan_expiry' ? (
                                  <>
                                    <p className="text-base font-bold text-slate-900">{reminder.title || 'Plan Expiry'}</p>
                    ...
                    {reminders.length === 0 ? (
                      ...
                      <div key={reminder.id} className="px-4 py-3 border-b border-slate-100 last:border-b-0 bg-white">
                        <div className="min-w-0">
                          {reminder.kind === 'plan_expiry' ? (
                            <>
                              <p className="text-sm font-bold text-slate-900">{reminder.title || 'Plan Expiry'}</p>
